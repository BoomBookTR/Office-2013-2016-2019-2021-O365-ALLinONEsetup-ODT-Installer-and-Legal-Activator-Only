...
title Office 2019 ProPlus Volume YÅkleniyor. KAPATMAYIN..!
echo ============================================================================&
echo #Proje: Office TEK TIKLAMA ile KURULUM&
echo ============================================================================&
echo.&
echo #DESTEKLEYEN VERSòYONLAR: Office 2019 ProPlus vb. &
echo.&
echo.& 
...
setup.exe /download 2019volume.xml
setup.exe /configure 2019volume.xml
::..\dosyalar\OfflineInstaller\2016-2021\setup19.exe /download "..\dosyalar\OfflineInstaller\2016-2021\2019volume.xml"
goto :secim

:cevrimdisi
cd %offlinesetupdir%
::echo %cd%
setup19.exe /configure 2019volume.xml
::..\dosyalar\OfflineInstaller\2016-2021\setup19.exe /configure "..\dosyalar\OfflineInstaller\2016-2021\2019volume.xml"

...
title Office 2016 ProPlus Volume YÅkleniyor. KAPATMAYIN..!
echo ============================================================================&
echo #Proje: Office TEK TIKLAMA ile KURULUM&
echo ============================================================================&
echo.&
echo #DESTEKLEYEN VERSòYONLAR: Office 2016 ProPlus vb. &
echo.&
echo.& 
...
:indir-me
::choice /n /c ÄY /m "Office yazçlçmç áevrimiái (Ä) mi yerel dosyalarla (Y) mç yÅklensin [Ä/Y]?" & if errorlevel 2 goto :cevrimdisi
...
setup.exe /download 2016volume.xml
setup.exe /configure 2016volume.xml
::..\dosyalar\OnlineInstaller\2016-2021\setup.exe /download "..\dosyalar\OnlineInstaller\2016-2021\2016volume.xml"
goto :secim

:cevrimdisi
cd %offlinesetupdir%
::echo %cd%
setup16.exe /configure 2016volume.xml
::..\dosyalar\OfflineInstaller\2016-2021\setup16.exe /configure "..\dosyalar\OfflineInstaller\2016-2021\2016volume.xml"
...
:devamet
Echo Hazçr oldußunda aktivasyon iülemine geáilecektir.

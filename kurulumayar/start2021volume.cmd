...
title Office 2021 ProPlus Volume YÅkleniyor. KAPATMAYIN..!
echo ============================================================================&
echo #Proje: Office TEK TIKLAMA ile KURULUM&
echo ============================================================================&
echo.&
echo #DESTEKLEYEN VERSòYONLAR: Office 2021 ProPlus vb. &
echo.&
echo.& 
...
setup.exe /download 2021volume.xml
echo Kurulum baülçyor...
setup.exe /configure 2021volume.xml
::..\dosyalar\OfflineInstaller\2016-2021\setup21.exe /download "..\dosyalar\OfflineInstaller\2016-2021\2021volume.xml"
goto :secim

:cevrimdisi
cd %offlinesetupdir%
::echo %cd%
setup21.exe /configure 2021volume.xml
::..\dosyalar\OfflineInstaller\2016-2021\setup21.exe /configure "..\dosyalar\OfflineInstaller\2016-2021\2021volume.xml"
